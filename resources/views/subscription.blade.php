...
<body class="justify-center items-center bg-theme-white text-theme-black font-['Calibri']">
    ...
    <div class="flex justify-center items-center w-full">
        ...
        <table class="text-center w-3/5 border border-sky-700">
            ...
            <tbody>
                <tr>
                    <td class="px-3 py-3 border border-cyan-600">現在のプラン</td>
                    <td class="px-3 py-3 border border-cyan-600">
                ...
                <tr>
                    ...
                    <td class="px-3 py-3 border border-cyan-600">3日</td>
                    <td class="px-3 py-3 border border-cyan-600">7日</td>
                </tr>

                <tr>
                    <td class="px-3 py-3 border border-cyan-600">広告</td>
                    <td class="px-3 py-3 border border-cyan-600">あり</td>
