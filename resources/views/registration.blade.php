...
<body class="justify-center items-center bg-theme-white text-theme-black font-['Calibri']">
    ...
    <div class="flex justify-center items-center pt-20">
        <div class="flex justify-center items-center w-full h-modal md:h-full">
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="flex flex-row justify-end items-center p-6 space-x-2 rounded-b border-t border-gray-200 dark:border-gray-600 gap-6">
                        <div class="flex flex-row gap-2">
                            <span>すでに登録？</span>
                            <a href="{{route('login')}}" class="text-blue-600 hover:text-blue-400 underline underline-offset-2">ログインする</a>
                        </div>
                        <button type="submit" class="text-white bg-blue-600 hover:bg-blue-400 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-600 dark:focus:ring-blue-400 w-1/5">登録</button>
                    </div>
                    </form>
                </div>
            </div>
