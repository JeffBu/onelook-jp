...
<body class="justify-center items-center bg-theme-white text-theme-black font-['Calibri']">
    ...
    <!--content-->
    <div>
        <h1 class="text-center text-3xl font-bold text-cyan-600 pb-10 pt-20">ログインパスワードを変更します。</h1>
    </div>
    ...
    <div class="flex justify-center items-center">
        <table class="text-center w-1/2 border border-sky-700">
            <tbody>
                <tr>
                    <th class="px-1 py-1 border-x border-y border-cyan-600 w-2/5">ログインID（変更できません）</td>
                    <td class="px-1 py-1 border-x border-y border-cyan-600">dad123</td>
                </tr>

                <tr>
                    <th class="px-1 py-1 border-x border-y border-cyan-600 w-2/5">旧パスワード</td>
                    <td class="px-1 py-1 border-x border-y border-cyan-600">********（変更日：2021/09/30）</td>
                </tr>

                <tr>
                    <th class="px-1 py-1 border-x border-y border-cyan-600 w-2/5">新パスワード</td>
                    <td class="px-1 py-1 border-x border-y border-cyan-600">
                        <input type="password" class="w-full text-center px-1 py-1">
                    </td>
                </tr>

                <tr>
                    <th class="px-1 py-1 border-x border-y border-cyan-600 w-2/5">新パスワード（確認用）</td>
                    <td class="px-1 py-1 border-x border-y border-cyan-600">
                        <input type="password" class="w-full text-center px-1 py-1">
                    </td>
                </tr>
