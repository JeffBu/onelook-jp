        ...
        <table class="text-center w-4/5 border border-sky-700">
            ...
            <tbody>
                ...
                <!-- <tr>
                    ...
                    <td class="px-3 py-3 border-x border-y border-cyan-600"><svg xmlns="http://www.w3.org/2000/svg" class="hidden h-5 w-5 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <tr>
                    ...
                    <td class="px-3 py-3 border-x border-y border-cyan-600"><button class="hidden container px-4 py-2 bg-theme-yellow text-theme-white hover:bg-yellow-300 rounded-md" >Register</button></td>
