...
<body class="flex flex-col justify-start items-center bg-theme-white text-theme-black font-['Calibri']">
    ...
    id="header_frame">
        ...
        <div class="justify-center items-center">
            <a href="{{route('dashboard')}}" class="font-semibold text-theme-white">OneLook</a>
        </div>
    ...
    <!--content-->
    <div class="flex flex-col justify-center items-center text-center text-black text-lg font-medium pt-11 w-3/5 min-h-screen gap-6">
        ...
        <h1 class="px-4 py-2 w-full text-2xl font-bold">このページは利用できなくなりました</h1>
        <span class="px-4 py-2 w-full">作者がこのページを削除した可能性があります。</span>
        <a href="{{route('dashboard')}}" class="text-sm text-sky-600 hover:text-sky-500 underline underline-offset-2">サイトに戻ります。</a>
    </div>
